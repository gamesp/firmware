...
// Initialize a PCF8574AT at I2C-address 0x3F, using GPIO5, GPIO4 and testWire for the I2C-bus
PCF857x pcf8574(0x3F, &testWire);
/**
 *  Half step, soft movement
 *
const static byte step_patternFBsoft[] = {
    B00010001, B00110011, B00100010, B01100110, B01000100, B11001100, B10001000, B10011001
};
const static byte step_patternLRsoft[] = {
